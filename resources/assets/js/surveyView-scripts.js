...
function myCreateFunction_for_guestattendancelist() {
    ...
    cell1.innerHTML = "Give a name";
    cell2.innerHTML = "give an organization2";
    cell3.innerHTML = "";
    cell4.innerHTML = "Give your Commentar";
}

function myDeleteFunction_for_guestattendancelist() {
